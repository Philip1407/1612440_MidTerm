...
export const MOVE_UNDO = "ROOM.MOVE_UNDO";
export const GAME_DRAW = "ROOM.GAME_DRAW";
export const SURRENDER = "ROOM.SURENDER";
...
export const onUndoRequest = () =>({
    type: MOVE_UNDO
})

export const onDrawRequest = () =>({
    type: GAME_DRAW
})